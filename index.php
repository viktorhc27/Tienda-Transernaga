...
<nav class="navbar navbar-main navbar-expand-lg navbar-light">
  <div class="container">
  	<a class="navbar-brand" href="http://bootstrap-ecommerce.com"><img src="resources/images/logo.png" class="logo"></a>
    ...
    <div class="collapse navbar-collapse" id="main_nav1">
      <ul class="navbar-nav mr-auto">
        ...
        <li class="nav-item dropdown">
          <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="http://example.com">More</a>
...
<div class="intro-banner-wrap">
	<img src="resources/images/banners/1.jpg" class="img-fluid rounded">
</div>
